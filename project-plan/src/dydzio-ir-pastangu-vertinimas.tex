...
Rizikų rezervas skirtas registre surašytoms rizikoms. Kiekvienai rizikai
...
rezervą valdo projekto vadovas. Su juo bazinis planas sudaro
...
Rizikų valdymo skyriaus registre nurodyta pradinė tikimybė, t.~y. kokia ji
būtų be jokių priemonių. Rezervui naudojome likutinę tikimybę, kuri lieka po
...
tikimybės atitinka rizikų valdymo skyriaus balus, o naujos rizikos IR2, OR2
...
\begin{itemize}
  \item vertinama tik bazinė versija (poreikiai 1--13); natyvi mobilioji
    programėlė, NFC ir QR identifikavimas, reklama, integracijos su sveikatos
    platformomis ir keli centrai yra išplėtimai ir į įvertį neįtraukti;
