...
%   nematomi) ir N1–N5 (įranga, turinio gamyba, bandymai objekte, mokymai, pilotas);
% - N4 = dokumentacija 14 + mokymų vedimas 12 žm. d., užsakovo darbuotojų laikas neįtrauktas;
%   N5 apima 20 d. d. garantinį palaikymą (10 žm. d.);
% - stulpelis „žm. d. / UFP“: P5 ir P6 santykis didžiausias – mažai funkcijų, bet realiojo laiko išvestis.
\textit{[Rengiama]}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}lXrrrrrr@{}}
    \toprule
    \textbf{Kodas} & \textbf{Eilutė} & \textbf{O} & \textbf{M} & \textbf{P} & \textbf{E} & {\boldmath$\sigma$} & \textbf{\makecell[r]{E / UFP,\\žm. d.}} \\
    \midrule
    ...
    N4 & Trenerių mokymai ir naudotojo dokumentacija & 16 & 25 & 40 & 26,0 & 4,0 & -- \\
    N5 & Pilotinis naudojimas, priėmimo bandymas ir perdavimas & 24 & 38 & 62 & 39,5 & 6,3 & -- \\
    \midrule
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}rl>{\raggedright\arraybackslash}Xrrr>{\raggedright\arraybackslash}p{2.1cm}@{}}
    ...
    11 & OR3 & Dalies pratimų perfilmavimas ir įgarsinimo perrašymas & 30 & 10 & 3,00 & N2, N5 \\
    \midrule
...
%   debesijos tiekėjo sutrikimas (TR3) į rezervą neįtrauktas, nes rizika perduota tiekėjui;
...
%   mažinimo veiklų: TR1 4 balai → 35~\% po bandomojo komplekto bandymo baseine (A10),
%   IR1 3 balai → 35~\% po prototipo bandymo baseine (A21), ER1 4 balai → 40~\% po bandomojo
%   klipo matomumo patikros (A74); kitų rizikų procentai atitinka registro balus.
\textit{[Rengiama]}
