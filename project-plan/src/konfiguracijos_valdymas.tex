...
\begin{enumerate}
    ...
    \item \textbf{Artefaktų valdymas (\emph{JFrog}):} Sukompiliuoti programiniai paketai bei aplikacijų laidų (\emph{releases}) versijos registruojami ir saugomi centralizuotoje artefaktų saugykloje (\emph{JFrog Artifactory}). Tai užtikrina, kad į baseino įrenginius patektų tik patvirtintos ir versijuotos programinės įrangos kopijos.
\end{enumerate}
