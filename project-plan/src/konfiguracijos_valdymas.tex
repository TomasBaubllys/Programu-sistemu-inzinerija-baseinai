...
\begin{itemize}
    ...
    \item \textbf{Aparatūra ir techninė įranga:} Vandeniui atsparūs ekranai, planšetės, belaidės ausinės, garso siųstuvai/imtuvai.
...
\begin{enumerate}
    \item \textbf{Programinio kodo valdymas:} Visi programavimo darbai saugomi centralizuotoje versijų kontrolės sistemoje (\emph{Git}). Atskiriamos pagrindinė (\texttt{main}), integracinė (\texttt{develop}) bei funkcinės šakos.
