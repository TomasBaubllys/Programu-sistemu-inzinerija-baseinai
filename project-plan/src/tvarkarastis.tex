...
(KT14). Garantinis palaikymas trunka 20~d.~d. iki liepos 28~d.;
liepos 29--30~d. vyksta projekto uždarymas.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}l>{\raggedright\arraybackslash}p{0.27\textwidth}l>{\raggedright\arraybackslash}X@{}}
    ...
    KT5 & Pagamintas ir patvirtintas pratimų vaizdo ir garso turinys & 2026-12-23 & Maždaug 40~pratimų vaizdo įrašų ir garso instrukcijų paruošta grotuvo formatu (Full HD), o 10~programų turinio planai suderinti su treneriais; treneriai pasirašė turinio priėmimo lapą. \\
    ...
    KT7 & Užsiėmimo programa vykdoma su filmuotu turiniu ir nutrūkus ryšiui & 2027-02-10 & Administratorius per sistemos sąsają įkelia patvirtintus pratimų failus; treneris iš jų sudaro programą, kuri paleidžiama per S1 bandomąją sąsają ir vykdoma ekrane bei ausinėse. Nutrūkus ryšiui grotuvas užbaigia programos etapą iš talpyklos. Pasirašytas 2~iteracijos demonstracijos protokolas. \\
    ...
    KT12 & Treneriai ir administratoriai išmokyti & 2027-05-17 & Kiekvienas pilotiniame naudojime dalyvaujantis treneris savarankiškai paleido ir užbaigė užsiėmimą; naudotojo vadovai perduoti, mokymų žiniaraštis pasirašytas. \\
    KT13 & Sistema priimta po pilotinio naudojimo & 2027-06-17 & Parengta 4~savaičių pilotinio naudojimo ataskaita; užsakovas pasirašė naudotojų priėmimo bandymo protokolą be kritinių pastabų. \\
    ...
    KT15 & Garantinis laikotarpis baigtas, projektas uždarytas & 2027-07-30 & Iki liepos 28~d. pasibaigė 20~d.~d. garantinis palaikymas ir ištaisyti kritiniai defektai; liepos 29--30~d. parengta bei užsakovo patvirtinta projekto uždarymo ataskaita. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
faile \texttt{project-plan/\allowbreak resources/\allowbreak schedule.csv}. Įrangos grandinė (užsakymas, 30~d.~d.
...
palaikymas. Šios veiklos neturi laisvo laiko, todėl jų vėlavimas nukelia
projekto pabaigą, jei jo nesugeria laiko rezervai B1 ir B2.
...
rezervas, ir KT11 bei KT14 datos nepasislenka. Laiko rezervų nereikia
painioti su sąnaudų rezervais (\ref{sec:dydis}~skyrius): pirmieji saugo
datas, antrieji – darbo sąnaudas (žm.~d.).
...
\begin{itemize}
  \item dirbama 5 dienas per savaitę po 8 valandas; valstybinės šventės yra
    ...
    liepos 6~d.);
  \item atostogos atskiromis veiklomis neplanuojamos: 1~iteracija apima ir
    2026~m. gruodžio 28--31~d. darbo dienas; jei komanda tuo metu
    atostogautų, 1~iteracijos demonstracija (KT6) pasislinktų, o vėlavimą
    sugertų laiko rezervas~B1;
  \item veiklos trukmė apskaičiuojama sąnaudas padalijus iš veiklai skirtų
    etatų sumos (pvz., testuotojas iteracijos testavimui skiria pusę etato)
    ir suapvalinus į didesnę pusę; valdymo, pilotinio naudojimo ir
    garantinio palaikymo trukmė nustatyta iš anksto, o jų sąnaudos lygios
    etato daliai, padaugintai iš trukmės;
