...
Lentelės eurų ribos taikomos patvirtinus projekto piniginį biudžetą;
šiame plane darbo sąnaudos įvertintos žm.~d. (\ref{sec:dydis}~skyrius).
Nepaisant pakeitimo lygio, valdymo rezervo (37~žm.~d.) panaudojimą
tvirtina užsakovas. Naujos funkcijos ir išplėtimai iš rezervų
automatiškai nefinansuojami.
